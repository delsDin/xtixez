      ...
      <div className="max-w-6xl w-full relative z-10 flex flex-col items-center">
        ...
        <div className="text-center mb-10 max-w-2xl">
          ...
          <p className="text-slate-600 dark:text-slate-350 text-sm sm:text-base leading-relaxed">
            Synchronisez vos cœurs en temps réel de manière magique. Prenez une pause d'une minute ensemble pour aligner vos respirations guidés par les vagues relaxantes de Dels 💖 pour Mike 👑.
          </p>
        </div>
