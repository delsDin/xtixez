...
export const TechBackground: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const symbols = isHopsonMode
      ? ['❤️', '💖', '💞', '🌹', '👑', '✨', '🥰', '💌', '🔐', '🌸', 'Toi & Moi', 'Mike 💖', 'Dels 👑', 'Amour', '<3', 'Toujours', '<dels>', '</dels>', '<hopson>', '</hopson>', '<hopson>🔐</dels>', '<dels>🔐</hopson>']
      : ['{ }', '< >', '01', '10', 'f(x)', 'dy/dx', '[]', '&&', '||', '=>', '++', 'py', 'x', '<dels>', '</dels>'];
  ...
  }, [darkMode, currentScheme, isHopsonMode]);
