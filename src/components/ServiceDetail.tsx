...
export const ServiceDetail = () => {
  ...
  const service = servicesData.find((s) => s.id === activeServiceId) || servicesData[0];
    ...
    return (
      <div className="py-20 text-center">
        ...
        <button 
          ...
          className="text-accent underline mt-4"
        >
          Retour aux services
        </button>
      </div>
          ...
          >
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {service.advantages.map((adv: string, aIdx: number) => (
                  <div 
                    key={aIdx} 
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-3">
                {service.useCases.map((uc: string, uIdx: number) => (
                  <div 
                    key={uIdx} 
