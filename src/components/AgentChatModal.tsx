  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: 'welcome',
      role: 'assistant',
      content: "Bonjour ! Je suis l'Agent IA de Dels Dinla. Je connais parfaitement ses compétences, son expérience et ses projets. Pose-moi n'importe quelle question et je te répondrai à sa place !"
    }
  ]);
